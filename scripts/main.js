...
// $('#bgFile input').prop('defaultValue', 'Browse')
// console.dir($('#bgFile input'));
$(function () {
    const COLORS = [
        "#eaff7b", "#00ffab", "#29bdc1", "#d84242", "#913f92", "#e81676", "#d718cf",
        "#f065f1", "#874df7", "#6b03c2", "#ae1f6e", "#3b415e", "#74a6cc", "#68d4c7",
    ...
    COLORS.forEach(elem => {
        $('.color-grid').append(`<div class="color-box" style="background-color: ${elem}"></div>`)
    });

    BG_IMAGES.forEach(elem => {
        $('.image-grid').append(`<div class="image-box" style="background-image: url('${elem}')"></div>`)
    });
    ...
    $(loginForm.password).bluer(function(event){
